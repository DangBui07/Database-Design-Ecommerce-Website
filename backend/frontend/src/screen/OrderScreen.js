...
function OrderScreen() {
    ...
    const successPaymentHandler = (paymentResult, bypassPayment = false) => {
        dispatch(payOrder( orderId , paymentResult, bypassPayment))
    }
            ...
            <Row>
                <Col md={8}>
                    <ListGroup variant='flush'>
                        ...
                        <ListGroup.Item>
                            <h2>Order Items</h2>
                            {order.orderItems.length === 0 ? <h2 variant='info'>
                                Order is empty
                            </h2> : (
                                <ListGroup variant='flush'>
                        ...
                        {userInfo && userInfo.isAdmin && !order.isPaid && (
                            <ListGroup.Item>
                                <Button
                                    type='button'
                                    className='btn btn-block'
                                    onClick={() => successPaymentHandler(null, true)}
